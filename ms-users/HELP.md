...
* The original package name 'com.dh.ms-users' is invalid and this project uses 'com.dh.msusers' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/docs/3.0.7/reference/htmlsingle/#web.security.oauth2.server)
